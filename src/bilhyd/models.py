...
# ------------------------Liaison entre les personnes (liaison n-n)----------------------------
    ...
    # il est recommandé que le nom du champ
...
class Job(models.Model):  # TSY MIASA ATO AM APPLI FA NIANARAKO FOTSINY
...
class Faculty(models.Model):    #TSY MIASA ATO AM APPLI FA NIANARAKO FOTSINY
...
# Ireto classe Employee sy Stuedent ireto
class Employee(Person):  # Ny employé dia personne ihany fa classe fille fotsiny
    ...
    #campus = models.ForeignKey('Campus', on_delete=models.DO_NOTHING)  # Ny Campus afaka mandray olona(employe) betsaka,
    # fa ny employe iray ana campus iray
    #job = models.ForeignKey('Job', on_delete=models.DO_NOTHING)  # Ny Job afaka ataon'olona betsaka, fa ny employé dia
